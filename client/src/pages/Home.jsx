    ...
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
        ...
        <div className='flex-1 px-6 py-20'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm text-sm px-4 py-2 
            rounded-full flex items-center gap-2'>
              <HiSparkles size={16} className="bg-green-50 text-green-600"></HiSparkles>
            ...
            items-center gap-10 mb-28'>
              {
                [
                  ...
                  hover:border-green-500 p-10 max-w-[90%] shadow-md  
                  hover:shadow-2xl 
                  ...
                  `}>
                    ...
                    items-center justify-center  shadow-lg'>{item.icon}</div>
                    <div className='pt-10 text-center'>
                      <div className='text-xs text-green-600 font-semobold mb-2 
               ...
               <span className=" text-green-600">Capabilities </span>
                ...
                <div className='grid md:grid-cols-2 gap-10'>
                  {[
                    ...
                    className='bg-white border border-gray-2
                    rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
