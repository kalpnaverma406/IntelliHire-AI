...
//=== for pdf===
  ...
  const downloadPDF =() =>{
    ...
    if(finalScore >= 8){
      advice = 
      "Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answers with stronger supporting examples.";
    }else if (finalScore >=5){
    ...
    px-4 sm:px-6 lg:px-10 py-8'>
      ...
      sm:justify-between gap-4'>
         ...
         <div className=' md:mb-10 w-full flex items-start gap-4  flex-wrap'>
                    ...
                    hover:shadow-md transition'><FaArrowLeft className='text-gray-800'/></button>
                    ...
                    <div>
                        ...
                        <p className='text-gray-500 mt-2'>
                           Ai-powered performance insights  </p>
                    </div>
                 </div>

              <button onClick={downloadPDF}
               className='bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-6
       ...
       <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        ...
        <div className='space-y-6'>
          ...
          text-center" >
            ...
            <div className='relative  sm:w-25 w-20 h-20  sm:h-25 mx-auto'>
                    <CircularProgressbar
                    value={percentage} 
                    text={`${score}/10`}
                    styles={buildStyles({
              ...
              animate={{opacity:1}}
               ...
               <div className='space-y-6'>
                {questionWiseScore.map((q,i)=>(
                 <div  key={i} className='bg-gray-250 p-4 sm:p-6 rounded-xl 
                  ...
                  sm:items-start gap-3 mb-4'>
                    ...
                    <div className=''>
                        <p className="text-xs text-gray-400">
                          Question{i +1} </p>
                          <p className="font-semobold text-gray-800 text-sm sm:text-base 
                          leading-relaxed">
                            {q.question || "Question not available"}
                          </p>
                    </div>

                    <div className='bg-green-100 text-green-600 px-3 py-1 rounded-full font-bold text-xs 
                    sm:text-sm w-fit'>
                      {q.score ?? 0}/10
                    </div>
                    </div> 
