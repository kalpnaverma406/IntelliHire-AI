     ...
     const[resumeText,setResumeText]=useState("");
      const[analysisDone,setAnalysisDone]=useState(false);
       ...
       const handleStart = async ()=>{
         setLoading(true)
        try {
         const result =await axios.post(ServerUrl + "/api/interview/generate-questions" ,{role, experience,
          mode, resumeText,projects,skills },{withCredentials:true})
          console.log(result.data)
          if(userData){
  ...
  return (
    ...
    justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4'>
      ...
      shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        from-green-50 to-green-100 p-12 flex flex-col justify-center'>
      ...
      <div className='space-y-5'>
        {
          [
            ...
            py-4 rounded-xl shadow-sm cursor-pointer '>
           {item.icon}
        ...
        className="p-12 bg-white">
          ...
          <div className='space-y-6'>
            ...
            <select value={mode}
               ...
               {projects.length>0 && (
                ...
                <p className='font-medium text-gray-700 mb-1'>
                  ...
                  <div className='flex flex-wrap gap-2'> 
                    {skills.map((s,i)=>(
                      <span key={i} className='bg-green-100 text-green-700 px-3 py-1 
                      rounded-full text-sm'>{s}</span>
                    ))}
                  </div>
                  </div>
               )}
             ...
             className='w-full disabled:bg-gray-600 bg-green-600 
