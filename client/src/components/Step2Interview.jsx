...
//import maleVideo from "../assets/videos/male.ai"
  ...
  useEffect(()=>{
    ...
    const runIntro =async ()=>{
      if(isIntroPhase){
        ...
        await speakText(
          "I'll ask you a few questions. Just answer naturally, and take youe time. Let's begin."
        );
...
useEffect(()=>{
  ...
  <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6
  space-y-6 border-r border-gray-200 '>
    <div className='w-ful max-w-md rounded-2xl overflow-hidden shadow-xl'>
       <video
          src={videoSource}
          key={videoSource}
          ref={videoRef}
  ...
  <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
    ...
    { !isIntroPhase  && (<div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl 
     border border-gray-200 shadow-sm'>
      ...
      <p className='text-xs sm:text-sm text-gray-400 mb-2'>
        Question {currentIndex + 1} of {questions.length}</p>
    ...
    <textarea 
        ...
        { !feedback ? (<div className='flex items-center gap-4 mt-6'>
            ...
            to-teal-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 
            transition font-semibold disabled:bg-gray-500'>  { isSubmitting?"Submitting...":"Submit Answer" }
          ...
          initial={{opacity:0 }}
          animate={{ opacity:1}}
           className='mt-6 bg-emarald-50 border 
          border-emerald-200 p-5 rounded-2xl shadow-sm'>
           ...
           to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition 
